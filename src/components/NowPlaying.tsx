...
export function NowPlaying() {
  return (
    <AnimatedCard delay={400} className="glow-amber border-primary/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.03]">
        <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] animate-[spin_20s_linear_infinite] origin-center">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-24 h-24 rounded-full bg-accent blur-3xl" />
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative w-16 h-16 shrink-0">
            <div className="w-16 h-16 rounded-full bg-[hsl(220_20%_8%)] border border-border/50 animate-[spin_3s_linear_infinite] flex items-center justify-center">
              <div className="w-10 h-10 rounded-full border border-border/30 flex items-center justify-center">
                <div className="w-4 h-4 rounded-full bg-primary/80 glow-amber-sm" />
              </div>
              {/* Grooves */}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 flex items-center gap-2">
              ...
              <div className="flex-1 h-1.5 bg-muted rounded-full overflow-hidden relative">
                <div className="h-full w-[58%] bg-primary rounded-full relative">
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full bg-primary border-2 border-background" />
                </div>
              </div>
        ...
        <div className="flex items-center justify-center gap-5">
          ...
          <button className="w-11 h-11 rounded-full bg-primary flex items-center justify-center text-primary-foreground hover:bg-primary/90 transition-all active:scale-95 duration-150 glow-amber-sm hover:shadow-[0_0_20px_hsl(38_92%_50%/0.3)]">
